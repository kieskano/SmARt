...
public class ImageProcessor implements ImgProcessor {
	...
	private static final int HUE_MIN = 24;		// The Hue,Saturation, Value/Brightness (HSV) values with minimum and maximum boundaries
	private static final int HUE_MAX = 60;		// HUE range: (0-180) and SAT/VAL range: (0-255)
	private static final int SAT_MIN = 70;
	private static final int SAT_MAX = 105;
	private static final int VAL_MIN = 141;
