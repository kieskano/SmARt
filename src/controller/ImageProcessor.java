...
public class ImageProcessor implements ImgProcessor {
  ...
  private static final int HUE_MIN = 14;    // The Hue,Saturation, Value/Brightness (HSV) values with minimum and maximum boundaries
  private static final int HUE_MAX = 38;   // HUE range: (0-180) and SAT/VAL range: (0-255)
  private static final int SAT_MIN = 103;
  private static final int SAT_MAX = 182;
  private static final int VAL_MIN = 135;
